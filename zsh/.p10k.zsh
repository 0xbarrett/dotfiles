...
() {
  ...
  POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(host context root_indicator dir_writable dir vcs)
  POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(command_execution_time background_jobs status anaconda asdf)
